export const perguntas = [
    {
        enunciado:"Como a legislação e as plataformas tecnológicas devem equilibrar o uso da Inteligência Artificial para a criação de deepfakes ultrarrealistas? O que vocẽ faria",
        alternativas:[
            {
                texto:"Inovação no entretenimento, educação e acessibilidade) com o imperativo de prevenir seu uso malicioso",
                afirmacao:[
                    "Os deepfakes ultrarrealistas são uma tecnologia de síntese de mídia crucial que deve ser protegida por seu potencial em democratizar a acessibilidade linguística (dublagens perfeitas), revolucionar o entretenimento (redução de custos e novas formas de arte) e aprimorar a educação (simulações históricas e de treinamento).",
                ],
                proxima: 1,
            },
            {
                texto: "O imperativo de prevenir o uso malicioso da IA sempre falhará, pois a regulação é lenta demais.",
                afirmacao: [
                    "A justificativa desfavorável está incorreta porque ignora a viabilidade da ação coordenada e o valor intrínseco da inovação, focando apenas no pessimismo.",
                ],
                proxima: 2,
            },
        ]
    ...
    {
        enunciado:"O uso de Inteligência Artificial para criar vídeos falsos ultrarrealistas (deepfakes) é uma das maiores polêmicas do futuro.Esta tecnologia destrói a confiança no que vemos?",
        alternativas:[
            {
                texto:"A principal controvérsia dos deepfakes reside no fato de serem vídeos ultrarrealistas que minam a confiança no conteúdo visual.",
                afirmacao:[
                    "O próprio contexto afirma que os deepfakes são 'vídeos falsos ultrarrealistas' e que esta tecnologia 'destrói a confiança no que vemos'. Portanto, o caráter ultrarrealista e a consequente destruição da confiança são a essência da polêmica destacada no texto.",
                ],
                proxima: 3,
            },
            {
                texto:"Deepfakes são vídeos falsos de baixa qualidade, e sua polêmica se deve apenas ao grande volume de conteúdo que eles geram.",
                afirmacao:[
                  "O texto descreve os deepfakes como 'ultrarrealistas', o que contradiz a afirmação de que seriam de 'baixa qualidade' e facilmente distinguíveis. A polêmica não se resume ao volume, mas sim ao perigo de não se conseguir mais discernir o que é real do que é falso.",
                ],
                proxima: 4,
            },
       ]
